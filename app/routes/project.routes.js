...
module.exports = function (app) {
    ...
    app.post('/api/v1/project/update', controller.updateProject);
    app.post('/api/v1/projectProgress/create', controller.createProjectProgress);
    app.post('/api/v1/projectProgress/update/:idProjectProgress', controller.updateProjectProgress);
    app.post('/api/v1/projectProgressLog/create', controller.createProjectProgressLog);
    app.post('/api/v1/projectProgressLog/update/:idProjectProgressLog', controller.updateProjectProgressLog);
    app.delete('/api/v1/project/delete/:id', controller.deleteProject);
    app.delete('/api/v1/projectProgressLog/delete/:id', controller.deleteProjectProgressLog);
}